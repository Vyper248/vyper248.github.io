...
export const projects = [
    ...
    },
    {
        ...
        description: 'EExperimenting with creating an animatable stick figure. Can create and save different poses and use those to create an animation. But it was never completed. Uses P5.',
        x: 0,
        y: 0,
        offset: 48,
        width: 200,
